...
const SodaCanIcon: React.FC<SodaCanIconProps> = ({
	size = 24,
	color = '#000000',
	strokeWidth = 20,
	style,
	...
	return (
		<Svg width={size} height={size} viewBox="0 0 470 470" style={style}>
			<Path
				d="M357.803,72.196l-19.711-19.711C339.275,51.159,340,49.416,340,47.5c0-4.143-3.358-7.5-7.5-7.5H195.607l27.196-27.196
