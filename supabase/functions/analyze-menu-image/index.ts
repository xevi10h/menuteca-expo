...
serve(async (req)=>{
  ...
  try {
    ...
    console.log('📄 Image data preview (first 50 chars):', imageData.substring(0, 50));
    ...
    return new Response(JSON.stringify({
      ...
      data: {
        ...
        menuData: {
          ...
          second_courses_to_share: menuWithIds.second_courses_to_share || false,
          ...
          includes_coffee_and_dessert: menuWithIds.includes_coffee_and_dessert || 'none',
